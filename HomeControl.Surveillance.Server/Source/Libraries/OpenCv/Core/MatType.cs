    ...
    public struct MatType: IEquatable<MatType>, IEquatable<int>
    {
        ...
        public override string ToString()
        {
            ...
            switch (Depth)
            {
                ...
                case CV_USRTYPE1:
                    ...
                    break;
                default:
                    throw new NotSupportedException("Unsupported CvType value: " + Value);
            }
        ...
        public static MatType MakeType(int depth, int channels)
        {
            if (channels <= 0 || channels >= CV_CN_MAX)
                throw new ArgumentOutOfRangeException("Channels count should be 1.." + (CV_CN_MAX - 1));
            if (depth < 0 || depth >= CV_DEPTH_MAX)
                throw new ArgumentOutOfRangeException("Data type depth should be 0.." + (CV_DEPTH_MAX - 1));
