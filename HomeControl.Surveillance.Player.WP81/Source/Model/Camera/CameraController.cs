...
namespace HomeControl.Surveillance.Player.Model
{
    public class CameraController
    {
        ...
        public Task StartZoomingInAsync() => !SupportsCommands ? UniversalTask.CompletedTask : ConsumerService.PerformAsync(Command.StartZoomingIn);

        public Task StartZoomingOutAsync() => !SupportsCommands ? UniversalTask.CompletedTask : ConsumerService.PerformAsync(Command.StartZoomingOut);

        public Task StopZoomingAsync() => !SupportsCommands ? UniversalTask.CompletedTask : ConsumerService.PerformAsync(Command.StopZooming);
    }
}
